    ...
    function updateCardContainer() {
      ...
      capturedRanges
        ...
        .forEach((data, index) => {
            ...
            deleteButton.innerHTML = `<img src="./src/icon_delete_svg.svg" alt="Delete icon">`;
            ...
            cardInput.addEventListener('input', function() {capturedRanges[capturedRanges.length - 1 - index].description = this.textContent});
